...
public class OzonMarketRefrigeratorsPage {
    ...
    public OzonMarketRefrigeratorsPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public OzonMarketRefrigeratorsPage filterFunctionalCheck(){
        this.clickMaxPrice();
        this.checkBrands();
        this.clickWithFreezer();
        this.clickNumberOfCameras();
        this.clickNumberOfCompressors();
        return new OzonMarketRefrigeratorsPage(driver);
    }
}
